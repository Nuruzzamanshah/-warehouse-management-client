      ...
      <div className="footer-content">
        <div className="footer-content-column">
          <div className="footer-logo">
            <a className="footer-logo-link" href="#">
              <span className="hidden-link-text">Nuru</span>
              <h1> WAREHOUSE BIYCLE </h1>
        ...
        <div className="footer-content-column">
          <div className="footer-call-to-action">
            ...
            <p className="footer-call-to-action-description"> Have a support question? Need to talk to legal? Have a great minestrone soup recipe? Whatever the reason you need to chat, let us know and we'll give you a call.</p>
            <a className="footer-call-to-action-button button" href="#" target="_self"> Get in Touch </a>
          </div>
          <div className="footer-call-to-action">
            <h2 className="footer-call-to-action-title"> You Call Us</h2>
            <p className="footer-call-to-action-link-wrapper"> <a className="footer-call-to-action-link" href="tel:01568235234" target="_self"> 01568235234 </a></p>
          </div>
        </div>
      ...
      <div className="footer-copyright">
        <div className="footer-copyright-wrapper">
          <p className="footer-copyright-text">
            <a className="footer-copyright-link" href="#" target="_self"> ©2022. | Warehouse Bicycle. | All rights reserved. </a>
          </p>
        </div>
      </div>
    </footer>
